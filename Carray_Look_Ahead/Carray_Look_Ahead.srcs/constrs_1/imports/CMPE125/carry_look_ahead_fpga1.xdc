...
set_property -dict {PACKAGE_PIN W2 IOSTANDARD LVCMOS33} [get_ports {B[0]}];  # Switch 4
set_property -dict {PACKAGE_PIN U1 IOSTANDARD LVCMOS33} [get_ports {B[1]}];  # Switch 5
set_property -dict {PACKAGE_PIN T1 IOSTANDARD LVCMOS33} [get_ports {B[2]}];  # Switch 6
set_property -dict {PACKAGE_PIN R2 IOSTANDARD LVCMOS33} [get_ports {B[3]}];  # Switch 7


set_property -dict {PACKAGE_PIN U16 IOSTANDARD LVCMOS33} [get_ports {A_LED[0]}];  #LED in1
set_property -dict {PACKAGE_PIN E19 IOSTANDARD LVCMOS33} [get_ports {A_LED[1]}];  #LED in1
set_property -dict {PACKAGE_PIN U19 IOSTANDARD LVCMOS33} [get_ports {A_LED[2]}];  #LED in1
set_property -dict {PACKAGE_PIN V19 IOSTANDARD LVCMOS33} [get_ports {A_LED[3]}];  #LED in1

set_property -dict {PACKAGE_PIN P3 IOSTANDARD LVCMOS33} [get_ports {B_LED[0]}];  #LED in2
set_property -dict {PACKAGE_PIN N3 IOSTANDARD LVCMOS33} [get_ports {B_LED[1]}];  #LED in2
set_property -dict {PACKAGE_PIN P1 IOSTANDARD LVCMOS33} [get_ports {B_LED[2]}];  #LED in2
set_property -dict {PACKAGE_PIN L1 IOSTANDARD LVCMOS33} [get_ports {B_LED[3]}];  #LED in2
set_property -dict {PACKAGE_PIN U3 IOSTANDARD LVCMOS33} [get_ports {c_o_led}];  #LED in2
set_property -dict {PACKAGE_PIN V13 IOSTANDARD LVCMOS33} [get_ports {c_i_led}];  #LED in
