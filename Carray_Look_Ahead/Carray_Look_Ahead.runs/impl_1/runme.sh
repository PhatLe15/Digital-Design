...
HD_PWD='C:/Users/Phat Le/Carray_Look_Ahead/Carray_Look_Ahead.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log carry_look_ahead_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source carry_look_ahead_fpga.tcl -notrace
