...
HD_PWD='C:/Users/Phat Le/Carray_Look_Ahead/Carray_Look_Ahead.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log carry_look_ahead_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source carry_look_ahead_fpga.tcl
