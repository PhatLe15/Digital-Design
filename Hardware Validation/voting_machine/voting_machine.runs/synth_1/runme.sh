...
HD_PWD='C:/Users/Phat Le/voting_machine/voting_machine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log voting_machine_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source voting_machine_fpga.tcl
