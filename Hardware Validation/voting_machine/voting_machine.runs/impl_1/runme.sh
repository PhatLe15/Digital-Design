...
HD_PWD='C:/Users/Phat Le/voting_machine/voting_machine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log voting_machine_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source voting_machine_fpga.tcl -notrace
