...
HD_PWD='C:/Users/Phat Le/priority_encoder/priority_encoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log enc_if.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source enc_if.tcl
