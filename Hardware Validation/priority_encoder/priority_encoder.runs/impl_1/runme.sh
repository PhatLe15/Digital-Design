...
HD_PWD='C:/Users/Phat Le/priority_encoder/priority_encoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log enc_if.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source enc_if.tcl -notrace
