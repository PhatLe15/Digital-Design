...
HD_PWD='C:/Users/Phat Le/shifter_rotator/shifter_rotator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_rotator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shift_rotator.tcl
