...
HD_PWD='C:/Users/Phat Le/shifter_rotator/shifter_rotator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_rotator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shift_rotator.tcl -notrace
