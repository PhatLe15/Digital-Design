...
HD_PWD='C:/Users/Phat Le/FIFO/FIFO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFO_FPGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIFO_FPGA.tcl
