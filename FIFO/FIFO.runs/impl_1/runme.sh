...
HD_PWD='C:/Users/Phat Le/FIFO/FIFO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFO_FPGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FIFO_FPGA.tcl -notrace
