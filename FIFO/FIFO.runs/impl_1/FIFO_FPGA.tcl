...
set rc [catch {
  ...
  add_files -quiet {{C:/Users/Phat Le/FIFO/FIFO.runs/synth_1/FIFO_FPGA.dcp}}
  read_xdc {{C:/Users/Phat Le/FIFO/FIFO.srcs/constrs_1/new/FIFO_constraints.xdc}}
  link_design -top FIFO_FPGA -part xc7a35tcpg236-1
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file FIFO_FPGA_timing_summary_routed.rpt -pb FIFO_FPGA_timing_summary_routed.pb -rpx FIFO_FPGA_timing_summary_routed.rpx -warn_on_violation "
  ...
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file FIFO_FPGA_bus_skew_routed.rpt -pb FIFO_FPGA_bus_skew_routed.pb -rpx FIFO_FPGA_bus_skew_routed.rpx"
...
set rc [catch {
  ...
  catch {file copy -force FIFO_FPGA.ltx debug_nets.ltx}
