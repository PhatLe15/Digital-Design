...
HD_PWD='C:/Users/phatle/Downloads/backup/integer_divider/integer_divider.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log integer_divider_FPGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source integer_divider_FPGA.tcl
