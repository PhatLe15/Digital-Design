...
HD_PWD='C:/Users/phatle/Downloads/backup/integer_divider/integer_divider.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log integer_divider_FPGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source integer_divider_FPGA.tcl -notrace
