...
HD_PWD='C:/Users/Phat Le/two-stage_pipelined_multiplier/two-stage_pipelined_multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log integer_multiplier_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source integer_multiplier_fpga.tcl
