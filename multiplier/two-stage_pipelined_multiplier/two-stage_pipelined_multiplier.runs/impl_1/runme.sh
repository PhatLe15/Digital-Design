...
HD_PWD='C:/Users/Phat Le/two-stage_pipelined_multiplier/two-stage_pipelined_multiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log integer_multiplier_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source integer_multiplier_fpga.tcl -notrace
